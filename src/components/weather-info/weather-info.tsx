...
export const WeatherInfo = () => {
  return (
    <section className='mb-8'>
      <div className='bg-[url(/images/bg-today-small.svg)] md:bg-[url(/images/bg-today-large.svg)] rounded-[20px] py-10 px-6 mt-8 mb-[20px] md:flex md:justify-between md:h-[286px] md:items-center'>
        <div>
